...
class AProcessor():
    ...
    def __call__(self, txt: str) -> str:
        ...
        while True:
            ...
            if "" != resp:
                self.conversation.Add(role = "SYSTEM", msg = "This is a message automatically generated by the function you just called to return the result. Function returned: {" + resp + "}")
