...
class APromptCoderProxy():
    ...
    def __init__(self, processor, storage, collection, conversations, formatter, outputCB = None):
        ...
        self.PATTERNS = {"CALL": [{"re": GenerateRE4FunctionCalling("CALL<!|agentType: str, agentName: str, msg: str|!> -> str"), "isEntry": True}],
                         ...
                         "SAVE_TO_FILE": [{"re": GenerateRE4FunctionCalling("SAVE_TO_FILE<!|filePath: str, code: str|!> -> str"), "isEntry": True}],
    ...
    def GetPatterns(self):
        primaryFunctions = FindRecords("programming, debugging, file operation, system operation.", [('type', 'primary')], len(self.PATTERNS) + 10, self.storage, self.collection + "_functions")
